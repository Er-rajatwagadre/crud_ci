    ...
    padding: 20px;margin-bottom: 40px; width:93%;">
            <div class="column1">
                <div class="mybox" >
                    ...
                    <a href="javascript;" class="btn btn-success" data-toggle="modal" data-target="#myModal" style="background-color:#0bc1cf;">Order Now</a>
                </div>
            </div>
        </div>
			  ...
			  <div class="modal-dialog">
				...
				<div class="modal-content">
				  ...
				  <div class="modal-body">
					<p><h1>PRAADIS10</h1></p>
					<p>This Code Are Unique And Special For Special Users Only!</p>
				  </div>
