...
<script>
 ...
 // $(document).ready(function(){
	 // $(".myvalue").click(function(){ 
			// var value = $(this).closest('td').find('.table_lead_id').val();
			// $("#lead_id_show").val(value);
	 // });
...
<script>
 ...
 <script type="text/javascript">
    // function showPosition(){
        ...
        // }
		// document.getElementById("result").value="Not Allowed 2132!";
...
<script src="<?php echo base_url(); ?>optimum/js/jquery.PrintArea.js" type="text/JavaScript"></script>
   ...
   <script>
    ...
    $('#example23').DataTable({
	    ...
	    <script src="<?php echo base_url(); ?>optimum\DataTables\Buttons-1.5.6\js\buttons.colVis.min.js"></script>
